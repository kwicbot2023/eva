...
BOT_TOKEN = environ.get('BOT_TOKEN', '5556181975:AAFEM7f5WsXhJK-ivXiWPXnkKDhPMJIcsas')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://te.legra.ph/file/8dfe7256883cbc0190478.jpg'))
# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '942099709').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001686640034').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "𝙆𝙒𝙄𝘾𝘽𝙊𝙏")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001620413958'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001480651413')).split()]
